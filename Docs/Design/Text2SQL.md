...
## Introduction
Screw writing sql queries. I want to be able to ask questions in plain english and get the data I want. This page will document the process of creating a text2sql functionality within tldw.
...
https://ai.gopubby.com/advanced-rag-retrieval-strategy-embedded-tables-fdb3e44003a5?gi=45e6d24924e5
