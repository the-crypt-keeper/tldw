...
from App_Function_Libraries.Web_Scraping.Article_Extractor_Lib import (
    scrape_and_summarize_multiple,  # or whichever you prefer
    scrape_from_sitemap,
    scrape_by_url_level,
)
from App_Function_Libraries.Web_Scraping.Website_scraping_tab import recursive_scrape
# etc. — basically import the same stuff your Gradio UI uses.
