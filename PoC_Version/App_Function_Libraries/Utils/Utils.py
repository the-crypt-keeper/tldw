...
def load_and_log_configs():
    ...
    try:
        ...
        local_llm_streaming = config.get('Local-API', 'local_llm_streaming', fallback='False')
        local_llm_temperature = config.get('Local-API', 'local_llm_temperature', fallback=0.7)
        local_llm_top_p = config.get('Local-API', 'local_llm_top_p', fallback=0.95)
        local_llm_max_tokens = config.get('Local-API', 'local_llm_max_tokens', fallback=4096)
        local_llm_api_timeout = config.get('Local-API', 'local_llm_api_timeout', fallback=90)
        local_llm_api_retries = config.get('Local-API', 'local_llm_api_retry', fallback=3)
        local_llm_api_retry_delay = config.get('Local-API', 'local_llm_api_retry_delay', fallback=5)
